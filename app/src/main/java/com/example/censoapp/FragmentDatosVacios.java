...
public class FragmentDatosVacios extends Fragment {
    ...
    public FragmentDatosVacios() {
        // Required empty public constructor
    }

    public static FragmentDatosVacios newInstance() {
        FragmentDatosVacios fragment = new FragmentDatosVacios();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_datos_vacios, container, false);
